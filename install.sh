...
curl -s https://raw.githubusercontent.com/YoungDeveloper2025/xray-reality-port80/master/default.json > config.json
...
json=$(curl -s https://raw.githubusercontent.com/YoungDeveloper2025/xray-reality-port80/master/config.json)
